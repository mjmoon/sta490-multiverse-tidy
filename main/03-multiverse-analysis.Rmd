...
ggplot(tmp, aes(y = position, x =redCards / games, colour = position_group)) +
  ...
  labs(y = NULL, x = "Proportion of red card received per match", 
       caption = stringr::str_wrap("Figure 1. The violins display the distributions of each player's proportion of games where they received a red card and the squares indicate the median value for each position. They suggest that the likelihood of receiving a red card in a soccer match may vary by position.", width = 95)) +
